...
<%
	...
	if(nome_session == null){
		...
		%>
		<center><a href="http://localhost:8080/aula-439-448-Projeto-Final-Java-Web/login.jsp"><button type="button" class="btn btn-primary">Voltar ao Login</button></a></center>
   <%  	
	}else{
	      ...
	      <form action="http://localhost:8080/aula-439-448-Projeto-Final-Java-Web/controller" method="POST">
	    	<select class="form-select" name="nome_excluir"  id="nome_excluir" aria-label="Default select example">
			   <%
				...
				String sql = "SELECT * from produtos_web";
